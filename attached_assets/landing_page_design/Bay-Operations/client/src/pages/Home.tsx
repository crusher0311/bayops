...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0d1b2a] overflow-hidden font-sans">
      ...
      <section className="relative pt-20 pb-32 bg-gradient-to-b from-[#0d1b2a] via-[#112240] to-[#0d1b2a]">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-[1.1] tracking-tight" data-testid="text-hero-title">
            ...
            <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto mb-12 leading-relaxed" data-testid="text-hero-subtitle">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
              ...
              <ContactDialog>
                <Button variant="outline" size="lg" className="w-full sm:w-auto text-lg h-14 px-8 rounded-xl border-slate-600 text-white hover:bg-white/10 hover:border-slate-500" data-testid="button-contact-us">
                  Contact Us
                </Button>
              </ContactDialog>
            </div>
      ...
      <section className="bg-[#112240] py-24 border-y border-white/5">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-orange-500/10 text-orange-400 mb-4 border border-orange-500/20">
              See It In Action
            </span>
          ...
          <div className="space-y-12">
            <motion.div 
              ...
              className="bg-[#1a2f4a] rounded-2xl shadow-2xl overflow-hidden border border-white/10"
            >
              <div className="bg-[#0d1b2a] px-4 py-3 flex items-center gap-2 border-b border-white/10">
                <div className="flex gap-1.5">
                  <div className="w-3 h-3 rounded-full bg-red-500/80"></div>
                  <div className="w-3 h-3 rounded-full bg-yellow-500/80"></div>
                  <div className="w-3 h-3 rounded-full bg-green-500/80"></div>
                </div>
                <span className="text-slate-400 text-sm ml-4 font-medium tracking-wide">Dashboard Overview</span>
              </div>
              <img src="/images/dashboard.png" alt="BayOPS Dashboard showing repair orders, revenue stats, and technician status" className="w-full h-auto" data-testid="img-dashboard" />
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="bg-[#0d1b2a] px-4 py-3 flex items-center gap-2 border-b border-white/10">
                  ...
                  <span className="text-slate-400 text-sm ml-4 font-medium tracking-wide">Repair Order Detail</span>
                </div>
                <img src="/images/repair-order.png" alt="Repair order detail screen with jobs, parts, and labor" className="w-full h-auto" data-testid="img-repair-order" />
              </motion.div>
              ...
              >
                <div className="bg-[#0d1b2a] px-4 py-3 flex items-center gap-2 border-b border-white/10">
                  ...
                  <span className="text-slate-400 text-sm ml-4 font-medium tracking-wide">Digital Vehicle Inspection</span>
                </div>
                <img src="/images/inspection.png" alt="Digital vehicle inspection with color-coded status indicators" className="w-full h-auto" data-testid="img-inspection" />
              </motion.div>
            </div>
          </div>
        </div>
